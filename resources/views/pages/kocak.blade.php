...
<body>
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Kucing Kocak</span>
            </a>
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button"
                    ...
                    <img class="w-8 h-8 rounded-full" src="images/kucing.jpg" alt="user photo">
                </button>
                <!-- Dropdown menu -->
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 p-4">
        <div>
            <img class="h-50 max-w-60 rounded-lg" src="images/kocak.jpeg" alt="">
        </div>
        <div>
            <img class="h-50 max-w-60 rounded-lg" src="images/kucing.jpg" alt="">
        </div>
        <div>
            <img class="h-50 max-w-60 rounded-lg" src="images/kocak.jpeg" alt="">
        </div>
    ...
    <div>
        <img src="images/kucing.jpg" alt="Kucing">
        <img src="images/kocak.jpeg" alt="Kocak">
        <h1>Kucing Kocak</h1>
    </div>
</body>